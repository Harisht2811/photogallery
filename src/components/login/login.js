  ...
  return (
    ...
    <form className='loginForm'>
      <div class="form-outline mb-4">
        ...
        <input name="email" type="email" id="form2Example1" class="form-control" onChange={(e) => setEmail("santhiyak30101999@gmail.com")} />
      </div>

      <div class="form-outline mb-4">
        <label class="form-label" for="form2Example2">Password</label>
        <input name="password" type="password" id="form2Example2" class="form-control" onChange={(e) => setPassword("28111999")} />
      </div>
